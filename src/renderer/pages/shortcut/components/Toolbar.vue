<template>
	<div class="toolbar" :style="style">
		<div class="toolbar-button iconfont iconmacguanbi" title="退出" @click.stop="click('cancel')"></div>
		<div class="toolbar-button iconfont icongou" title="完成" @click.stop="click('done')"></div>
	</div>
</template>
